...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersList = __webpack_require__(157);
	...
	var App = React.createClass({displayName: "App",
	    ...
	    render: function() {
	        return React.createElement(UsersList, {data: this.state.users});
	    }
	});
	...
	module.exports = React.createClass({displayName: "module.exports",
	    renderUsers: function() {
	        return this.props.data.map(function(user) {
	            return React.createElement(User, {data: user, key: user._id});
	        });
	    },
	    render: function() {
	        return (
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Orders = __webpack_require__(159);

	module.exports = React.createClass({displayName: "module.exports",
	    render: function() {
	        return (        
	            React.createElement("div", null, 
	                React.createElement("p", null, this.props.data.username, " (", React.createElement("em", null, this.props.data.name.last, ", ", this.props.data.name.first), ") – ", this.props.data.email), 
	                React.createElement("p", null, React.createElement("strong", null, "ORDERS:")), 
	                React.createElement(Orders, {data: this.props.data.orders})
	            )
	        );  
	    }
	});
	...
	module.exports = React.createClass({displayName: "module.exports",
	    renderOrders: function() {
	        return this.props.data.map(function(order) {
	            return React.createElement("li", null, order.name, " - ", order.price, " X ", order.qty);
	        });
	    },
	    render: function() {
	        return (
